      ...
      <div className="w-full flex h-auto items-center justify-between px-4 md:px-8 lg:px-12">
        ...
        <Link href="/" className="flex items-center space-x-3">
          <div className="h-14 w-14 rounded-full border border-[#2d1a11] overflow-hidden bg-[#120a07] flex items-center justify-center">
            <Image src="/images/logo.jpg" alt="Chai Bisket" width={56} height={56} className="object-contain p-0.5" />
          </div>
          <div>
        ...
        <div className="flex items-center gap-4 ml-auto">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link href="#moments" className="text-[#f5eddc]/80 hover:text-[#ffd9a0] transition-colors font-medium">Moments</Link>
            <Link href="#location" className="text-[#f5eddc]/80 hover:text-[#ffd9a0] transition-colors font-medium">Location</Link>
            <Link href="#write-to-us" className="text-[#f5eddc]/80 hover:text-[#ffd9a0] transition-colors font-medium">Contact Us</Link>
          </div>
        ...
        isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-[#120a07] border-b border-[#2d1a11] shadow-lg z-[100] rounded-b-3xl">
            <div className="container px-4 py-3 flex flex-col space-y-3">
              ...
              <a href="#moments" className="block py-3 text-[#f5eddc] border-b border-[#2d1a11]" onClick={() => setIsMenuOpen(false)}>
                Moments
              </a>
              <a href="#location" className="block py-3 text-[#f5eddc] border-b border-[#2d1a11]" onClick={() => setIsMenuOpen(false)}>
                Location
              </a>
              <a href="#write-to-us" className="block py-3 text-[#f5eddc]" onClick={() => setIsMenuOpen(false)}>
                Contact Us
              </a>
