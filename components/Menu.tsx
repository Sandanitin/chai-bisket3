              ...
              return (
                ...
                >
                  <div className="relative h-40 sm:h-48 md:h-56 w-full">
                    ...
                    {/* Discount Badge */}
                    {discountPercent && (
                      <div className="absolute top-3 right-3 bg-red-600 text-white text-xs font-bold px-2 py-1 rounded shadow-md z-10">
                        {discountPercent}% OFF
                      </div>
                    )}
                        ...
                        <div className="flex flex-col items-end">
                          {item.originalPrice &&
                            item.originalPrice > item.price && (
                              <span className="text-white/60 text-xs sm:text-sm line-through decoration-white/50">
