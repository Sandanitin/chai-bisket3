      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-[#120a07] rounded-2xl shadow-sm border border-[#2d1a11] p-8 space-y-6 text-[#f5eddc]/80 leading-relaxed">
          <section>
            ...
            <p>
              By accessing and using the Chai Bisket website and services, you
          ...
          <section>
            ...
            <p>
              Our website allows you to browse our menu, place orders for pickup
              or delivery, and learn about our catering services. You agree to
              use these services only for lawful purposes and in accordance with
              these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              When you place an order, you agree to provide accurate and
              complete information. All prices are subject to change without
          ...
          <section>
            ...
            <p>
              The content, design, and logos on this website are the property of
              Chai Bisket and are protected by copyright and other intellectual
          ...
          <section>
            ...
            <p>
              Chai Bisket shall not be liable for any indirect, incidental,
